...
function App() {
  return /* @__PURE__ */ import_react.default.createElement("html", null, /* @__PURE__ */ import_react.default.createElement("head", null), /* @__PURE__ */ import_react.default.createElement("body", null, /* @__PURE__ */ import_react.default.createElement(
    "h1",
    {
      onClick: () => {
        console.log("test");
...
var server = (0, import_http.createServer)(async (req, res) => {
  if (req.url !== "/") {
    try {
      const stream2 = (0, import_fs.createReadStream)(`.${req.url}`);
      stream2.pipe(res);
    } catch (e) {
      res.end();
    }
  ...
  const stream = (0, import_server.renderToPipeableStream)(/* @__PURE__ */ import_react2.default.createElement(app_default, null), {
